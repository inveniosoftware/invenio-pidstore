...
g = {}
with open(os.path.join(os.path.dirname(__file__), '..', 'invenio_pidstore',
                       'version.py'), 'rt') as fp:
    exec(fp.read(), g)
...
latex_documents = [
  (master_doc, 'invenio-pidstore.tex', u'invenio-pidstore Documentation',
   u'CERN', 'manual'),
]
...
man_pages = [
    (master_doc, 'invenio-pidstore', u'invenio-pidstore Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'invenio-pidstore', u'Invenio-PIDStore Documentation',
   author, 'invenio-pidstore', 'Invenio module that stores and registers persistent identifiers.',
   'Miscellaneous'),
]
